    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_status', models.CharField(blank=True, choices=[('READY_TO_PICK', 'READY_TO_PICK'), ('IN_TRANSIT', 'IN_TRANSIT'), ('WASHING', 'WASHING'), ('WASHING_DONE', 'WASHING_DONE'), ('DRYING', 'DRYING'), ('DRYING_DONE', 'DRYING_DONE'), ('IN_SEGREGATION', 'IN_SEGREGATION'), ('SEGREGATION_DONE', 'SEGREGATION_DONE'), ('READY_FOR_DELIVERY', 'READY_FOR_DELIVERY'), ('DELIVERED_TO_CAMPUS', 'DELIVERED_TO_CAMPUS'), ('DELIVERED_TO_STUDENT', 'DELIVERED_TO_STUDENT')], max_length=100, null=True)),
